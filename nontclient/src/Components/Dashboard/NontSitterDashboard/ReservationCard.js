            ...
            return(
                ...
                <a href={"/reserveInfo/" + reservation._id} className="m-2">
                    <div className={"card mt-3 " + styles.reservationCard}>
                        <div className="header card-header text-white bg-primary" style={{fontSize: "20px", fontWeight: '600', borderRadius: "10px 10px 0px 0px"}}>
                            {_.truncate(reservation.shelter_id.name?reservation.shelter_id.name:"Shelter", { length: 25 })}
                        </div>
                        <div className="card-body">
                            <h5 className="header card-title">
                            {_.truncate(reservation.nontowner_id.name?reservation.nontowner_id.name:"Owner", { length: 25 })}
                            </h5>
                            <div className="row align-items-center">
                            <div className="header col-12 col-md-4 col-sm-3 text-center" style={{fontWeight: '600', color: "black", opacity: "0.8"}}>
